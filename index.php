                ...
                <?php if ($this->getTotal() != 0): ?>
                    ...
                    <?php while ($this->next()): ?>
                        ...
                        <?php if ($this->options->ThumbnailOption == '1'): ?>
                            <div class="post-thumbnail-pure mdl-card__media mdl-color-text--grey-50 lazy " <?php getBackgroundLazyload(showThumbnail($this)); ?>>
                        <?php elseif ($this->options->ThumbnailOption == '2'): ?>
                            <div class="post_thumbnail-random mdl-card__media mdl-color-text--grey-50 lazy " <?php getBackgroundLazyload(randomThumbnail($this)); ?>>
                        <?php endif; ?>
                                <div class="article-headline">
                                    <a href="<?php $this->permalink() ?>" target="_self"><?php $this->title() ?></a>
                                    <div class="post_entry-info">
                                        <div class="post_entry-left-info"> <span> RELEASE:
                                        ...
                                        <div class="post_entry-right-info">
                                            <span class="post_entry-category"> <?php $this->category(', '); ?> <?php if ($this->options->commentis == '0' || (!getThemeOptions('SwitchToDisqusSince') == '' || !getThemeOptions('SwitchToDisqusSince') == null) && $this->cid < (int)getThemeOptions('SwitchToDisqusSince')): ?> | </span>
                                                <!-- Comment Count --> <?php $this->commentsNum('%d 评论'); ?>
                                                <?php endif ?>
                                            </div>  
                                        </div>
                                </div>
